(function ( $, x5engine ) {
	...
	s.siteId = 'F4C529CBBB798B5B0D8CEA0CBCF3424F';
	s.version = '17-1-2-0';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function() { x.cookielaw.showBanner({id: "cookie-law-message",texts: [
		{ basepath: "", text: "<div><br></div><div><br></div><div><br></div><div><br></div><div><br></div><div><br></div><div><br></div>Diese Seite benutzt Cookies , lesen Sie bitte die Datenschutzhinweise." },
		{ basepath: "../", text: "<div><br></div><div><br></div><div><br></div><div><br></div><div><br></div><div><br></div><div><br></div>Diese Seite benutzt Cookies , lesen Sie bitte die Datenschutzhinweise." }
	],
